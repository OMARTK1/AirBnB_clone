...
def __print_stdout(msg):
    """It prints message in STDOUT
    """
    sys.stdout.write(msg)


def __print_stderr(msg):
    """It prints message in STDERR
    """
    sys.stderr.write(msg)


def __analyse_html(file_path):
    """It starts analyse of HTML file
    """
...
def __analyse(file_path):
    """It starts analyse of a file and print the result
    """
    nb_errors = 0
    try:
        result = None
...
def __files_loop():
    """The loop that analyses for each file from input arguments
    """
    nb_errors = 0
...
if __name__ == "__main__":
    ...
    """It executes tests, then exit. Exit status = # of the errors (0 on success)
    """
